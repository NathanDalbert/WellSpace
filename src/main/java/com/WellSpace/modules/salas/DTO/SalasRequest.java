...
public record SalasRequest(
        ...
        @NotBlank(message = "A disponibilidade da sala durante a semana não pode estar vazia")
        @Schema(example = "Segunda a Sexta", description = "Disponibilidade semanal da sala")
